...
import 'package:twigconnect/models/user.dart';
    ...
    final userImage = Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(user.photo.toString()),
          fit: BoxFit.cover,
        ),
    ...
    final thirdCard = Padding(
      ...
      child: Material(
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              _buildIconTile(LineIcons.moneyBill, Colors.red, 'My Wallet'),
              hr,
              _buildIconTile(LineIcons.plug, Colors.blue, 'VIP Center'),
              hr,
              _buildIconTile(LineIcons.userPlus, Colors.orangeAccent, 'Find Friends'),
              hr,
              _buildIconTile(LineIcons.userTag, Colors.black, 'Blacklist'),
              hr,
